...
describe("/api/genres", () => {
  ...
  describe("POST /", () => {
    ...
    it("it should return 400 if genre is more than 50 characters", async () => {
    ...
    it("it should save the genre if valid", async () => {
      await exec();
    ...
    it("it should return the genre if valid", async () => {
      const res = await exec();
